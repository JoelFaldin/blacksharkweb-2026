  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <p className="text-xs uppercase tracking-[0.2em] text-foreground">Seguridad</p>
        <h3 className="text-2xl font-semibold text-foreground">Actualizar contraseña</h3>
        <p className="text-sm text-foreground/70">Ingresa tu nueva contraseña para continuar.</p>
      </div>
      ...
      <div className="mt-10">
        <button
          type="submit"
          className="group relative w-full overflow-hidden rounded-xl bg-primary py-3.5 text-sm font-semibold text-background shadow-lg shadow-primary/20 transition-all duration-200 hover:shadow-xl hover:shadow-primary/80 hover:brightness-110 active:scale-[0.98] cursor-pointer"
        >
          <span className="relative z-10 text-background">Actualizar contraseña</span>
        </button>
      </div>
    </form>
  );
