          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-6 text-(--muted-foreground) leading-relaxed">
              <p>
                ...
                propósito y motivar a las personas a actuar.
              </p>
              <p>
                ...
                desde startups que buscan encontrar su voz hasta marcas consolidadas que desean
                reinventarse.
              </p>
              <p>
                Creemos en una estética minimalista con máximo impacto. Nuestro trabajo elimina lo
                innecesario para revelar lo que realmente importa: la identidad central de tu marca,
                comunicada con precisión y excelencia.
              </p>
            </div>
